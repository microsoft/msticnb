...
def nbltdata():
    ...
    test_config = str(Path.cwd().joinpath(_TESTDATA_FOLDER).joinpath("msticpyconfig-test.yaml"))
...
def test_ouput_values(nbltdata):  # pylint: disable=redefined-outer-name
    ...
    assert nbltdata.picker.alerts.iloc[0]['SystemAlertId'] == "f1ce87ca-8863-4a66-a0bd-a4d3776a7c64"
